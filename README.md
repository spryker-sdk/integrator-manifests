# integrator-manifests

Module manifests for [SprykerSdk.Integrator](https://github.com/spryker-sdk/integrator) tool.
...
Any vendor based module can have manifests here.
...
Only released versions can be added. So please make sure you only add/merge manifests after their module release has been done.
